    ...
    <div className="min-h-screen bg-black text-white p-8 md:p-16">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-400 mb-8 max-w-2xl">
          Upload images from your PC, then assign them to specific sections of your website (e.g. "psi-lab-hero", "work-aether-cover"). The changes will reflect immediately.
        </p>
          ...
          <div>
            ...
            <div className="bg-zinc-900 border border-white/10 p-6 mb-6">
              ...
              <div className="flex flex-col gap-4">
                <input 
                  type="text" 
                  placeholder="e.g. psi-lab-hero, work-pulse-cover" 
                  value={newSlotKey}
